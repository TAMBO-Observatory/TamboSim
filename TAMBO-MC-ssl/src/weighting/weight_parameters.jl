...
"""
    WeightParameters(area, pl, as, ...)

Cross-section-free constructor for `WeightParameters`.
Used for atmospheric muon injection where no neutrino cross-section is involved.
"""
function WeightParameters(
    area::Quantity{T,ldim^2,typeof(u"m^2")},
    pl::UnitfulPowerLawSampler{T},
